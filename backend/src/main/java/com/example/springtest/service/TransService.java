...
public class TransService {
    ...
    TransService(TransactionRepository transactionRepository) {
     ...
     * @return
     */
    public ResponseTransactionDTO getTransactionAllByUserId(Integer userId) {
    ...
    public TransDTO updateTransaction(Integer userId, TransDTO transDTO) throws Exception {
    ...
    public void createTransaction(Integer userId, TransDTO transDTO) throws Exception {
